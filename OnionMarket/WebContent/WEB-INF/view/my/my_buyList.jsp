...
UsersVO vo = (UsersVO)session.getAttribute("loginUser");
	...
	List<ProdMyAllVO> buyList = (List<ProdMyAllVO>)request.getAttribute("buyList");
%>
            <div class="inner">
                ...
                <section class="content-area">
                    <div class="mypage-list">
                        <h1 class="heading2">구매내역</h1>

                        <!-- history-area 시작 -->
                        <div class="history-area">
                            <ul>
     <%
     for(ProdMyAllVO prodmyvo : buyList){
     %>
                                <li>
                                    <div class="item">
                                        <div class="img-box">
                                        ...
                                        <div class="txt-wrap">
                                            <p class="cate"><%=prodmyvo.getCate_nm()%></p>
                                            <p class="tit"><%=prodmyvo.getTit() %></p>
                                            <p class="price"><%=prodmyvo.getPrice() %></p>
                                        </div>
                                    </div>
                                    <input type="button" value="후기작성" class="review-btn1">
                                </li>
     <%
     }
     %>  
