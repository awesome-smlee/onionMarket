				...
				<form id="userForm" method="post" enctype="multipart/form-data"
					...
					<ul>
						...
						<li class="input-group"><label for="pw2">비밀번호 확인<i
							...
							<p class="msg-txt2">비밀번호가 일치하지 않습니다. 동일한 비밀번호를 입력해주세요.</p></li>
						...
						<li class="input-group"><label for="nick_nm">닉네임<i
							...
							<div class="wrap">
								...
								<input type="text" id="nick_nm" name="nick_nm" class="input">
						...
						<li class="input-group"><label for="aa">프로필사진</label> <input
							type="file" name="" id=""></li>
