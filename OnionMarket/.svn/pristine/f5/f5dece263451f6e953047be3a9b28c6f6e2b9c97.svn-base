...
function performSearch() {
    ...
    // 검색 옵션과 키워드를 서버로 전송하는 로직
    // 여기에 Ajax나 Fetch 등을 사용하여 서버로 데이터를 전송하는 코드를 작성해야 합니다.
    // 서버로 전송할 때는 선택한 옵션과 키워드를 함께 전달해야 합니다.
}
...
<div class="form-area">
    ...
    <div class="input-form">
        <input type="text" id="searchKeyword" placeholder="검색할 내용을 입력하세요">
    </div>
    <a href="javascript:void(0)" class="search-btn" onclick="performSearch()">
    	<i class="xi-search" style="color:#fff;"></i>
    </a>
</div>
