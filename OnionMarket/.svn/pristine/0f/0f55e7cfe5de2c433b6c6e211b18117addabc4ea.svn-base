            ...
            <div class="inner">
                    ...
                    <ul class="mypage-menu">
                        <li>
                            <div class="profile-area">
                                ...
                                <a href="<%=request.getContextPath()%>/my/mainMy.do">프로필 설정</a>
                            </div>
                        </li>
                        <li>
                             <p class="tit">나의 거래</p>
                            ...
                            <a href="<%=request.getContextPath()%>/my/locationStart.do" class="active">내 동네 설정</a>
                            <a href="<%=request.getContextPath()%>/my/keywordMy.do">알림 키워드 설정</a>
                        </li>
                        <li>
                            <p class="tit">내 동네 활동</p>
                            <a href="<%=request.getContextPath()%>/com/comList.do">커뮤니티</a>
                        </li>
                        <li>
                ...
                <section class="content-area">
                    <div class="mypage-list">
                        ...
                        <div class="btn-area">
                            <input type="button" value="저장하기" class="btn-style4" id="save">
                        </div>
                    </div>
    ...
    kakao.maps.event.addListener(map, 'click', function(mouseEvent) {
        ...
        geocoder.coord2Address(coords.getLng(), coords.getLat(), callback);
             ...
             var mypath =  '<%= request.getContextPath() %>';
            	  ...
            	  $.ajax({
                      type: "post",
                      url: `${mypath}/my/locationMy.do`, // 실제 서블릿 URL로 변경
                      data: { "dong": dong },
                     error: function(response) {
                          // 성공적으로 응답을 받았을 때의 처리
                          alert(dong);
                    	  alert('내 동네가 설정되었습니다');
                    	  location.href = "<%=request.getContextPath()%>/my/mainMy.do";
                      }
