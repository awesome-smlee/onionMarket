            ...
            <div class="inner">
                <aside class="left-menu">
                    ...
                    <div class="category-box">
                        ...
                        %>
                            <li>
                                <a href="javascript:void(0)"><%=cate.getCate_nm() %></a>
                            </li>
                        <%
                        	}
                        %>
                        ...
                        <div class="board-reply-area">
                            ...
                            <div class="reply-box">
                                <div class="profile-area">
                                    ...
                                    <p class="nikname"><%=repVo.getIns_id() %></p>
                                </div>
                                <p class="comment"><%=repVo.getCont() %></p>
                                <p class="date"><%=repVo.getIns_dt() %></p>
                            </div>
                            <div class="btn-box">
                                <input type="button" value="수정" class="delete-btn">
                                <input type="button" value="삭제" class="update-btn">
                            </div>
							<%
							}
							%>
