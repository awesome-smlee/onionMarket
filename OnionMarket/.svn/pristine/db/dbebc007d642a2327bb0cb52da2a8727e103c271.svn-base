		...
		<main class="sub-page">
			...
			<div class="inner">
				...
				<section class="content-area">
					<form action="<%=request.getContextPath()%>/com/comInsert.do" enctype="multipart/form-data" method="post">
						<h1 class="heading1">게시글 등록</h1>
						<div class="commu-list">
							<ul class="insert-cont">
								...
								<input	type="text" name="title" placeholder="제목을 입력해주세요"></li>
								<li class="input-group"><label for="">내용</label> <textarea
										name="content" cols="30" rows="10" placeholder="내용을 입력해주세요"></textarea>
								</li>
						...
						<div class="btn-area">
							<input type="submit" value="게시글 등록하기" class="btn-style4">
						</div>
					</form>
				</section>
			</div>
