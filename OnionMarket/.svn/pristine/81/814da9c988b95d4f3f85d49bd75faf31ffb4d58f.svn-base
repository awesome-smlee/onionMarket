...
@WebServlet("/my/wishlistMy.do")
public class WishlistMy extends HttpServlet {
...
//		System.out.println("카테고리명" + myList);
		
		
		
		request.setAttribute("myList", myList);
		request.getRequestDispatcher("/WEB-INF/view/my/my_wishlist.jsp")
