                    ...
                    <div class="product-view-area">
                        <div class="product-item">
                                ...
                                <div class="swiper prodViewSwiper">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="../img/example/img1.jpg" alt="">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="../img/example/img1.jpg" alt="">
                                        </div>
                            ...
                            <div class="txt-wrap">
                                ...
                                <br>
                            	<p class="like">좋아요<span class="num"><%=proVo.getLike_cnt()%></span></p>
                                ...
                                <div class="txt-info">
                                    <p>조회수<span class="num"><%=proVo.getVw_cnt() %></span></p>
                        ...
                        <div class="product-area">
                            ...
                            <!-- <a href="javascript:void(0)" class="btn-style8">채팅하기</a> -->
                            <a href="javascript:void(0)" class="btn-style9">신고하기</a>
                        </div>
                      ...
                      <!--   <div class="location-map">
                        ...
                        <div class="btn-area">
                            <a href="<%=request.getContextPath()%>/pro/proUpdate.do" class="btn-style6">수정하기</a>
                            <input type="button" value="삭제하기" class="btn-style5">
                        </div>
                    </div>
                        <button modal-id="modal1" style="background: #ddd;">거래완료 셀렉트 선택시</button>
                </section>
            </div>
        </main>
