...
$(function() {
	$('#insert').on('click', function() {
		location.href = "<%=request.getContextPath()%>/com/comInsertForm.do";
	});
	
	$('.cate').on('click', function() {
		var catekind = $(this).val();
		$.ajax ({
			url : "<%=request.getContextPath()%>/com/comListByCate.do",
			type : "post",
			data : { "catekind" : catekind },
			// dataType : "html",
			success : function(data) {
				$('.commu-list .history-area ul').html(data);
			},
			error : function(xhr) {
	...
	$('.gu').on('click', function() {
		var gukind = $(this).val();
		$.ajax ({
			url : "<%=request.getContextPath()%>/com/comListByGu.do",
			type : "post",
			data : { "gukind" : gukind },
			// dataType : "html",
			success : function(data) {
...
<body>
	<div>
		...
		<main class="sub-page">
            ...
            <!-- sub-menu 시작 -->
            <div class="sub-menu">
                <a href="javascript:location.reload()" class="active">동네 커뮤니티</a>
            ...
            <div class="inner">
                <aside class="left-menu">	
                    ...
                    <div class="category-box">
                        ...
                        <ul class="select-group">
                            <li>
                            	<input style="font-size: 18px; padding: 10px 0px; background: white;" type="button" value="대덕구" class="gu">
                            </li>
                            <li>
                                <input style="font-size: 18px; padding: 10px 0px; background: white;" type="button" value="유성구" class="gu">
                            </li>
                            <li>
                                <input style="font-size: 18px; padding: 10px 0px; background: white;" type="button" value="중구" class="gu">
                            </li>
                            <li>
                                <input style="font-size: 18px; padding: 10px 0px; background: white;" type="button" value="서구" class="gu">
                            </li>
                            <li>
                                <input style="font-size: 18px; padding: 10px 0px; background: white;" type="button" value="동구" class="gu">
                            </li>
                        </ul>
                    </div>
