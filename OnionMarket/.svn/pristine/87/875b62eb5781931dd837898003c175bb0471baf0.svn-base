            ...
            <div class="inner">
                ...
                <section class="content-area">
                    <div class="mypage-list">
                        ...
                        <form action="<%=request.getContextPath()%>/my/deleteMy.do" 
		method="post" enctype="multipart/form-data">
                            <div class="user-out-area">
                                <ul>
                                    <li class="input-group">
                                        <label>아이디</label>
                                        <input type="text" value="<%=userVo.getUser_id()%>">
                                    </li>
                                    <li class="input-group">
                                        <label for="aa">비밀번호</label>
                                        <input type="password" id="pw" name="pw" placeholder="비밀번호를 입력하세요">
                                    </li>
                                    <li class="input-group">
                                        <label for="aa">탈퇴사유</label>
                                ...
                                <div class="btn-area">
                                    <input type="button" value="탈퇴하기" class="btn-style4" modal-id="modal1">
                                </div>
                            </div>
